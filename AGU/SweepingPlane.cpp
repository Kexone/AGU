...
int SweepingPlane::locationOfPoint(cv::Point2f p1, cv::Point2f p2, cv::Point2f p3)
{
...
void SweepingPlane::locatePoint(cv::Mat &duplicate, std::vector<cv::Point2f> polyP, cv::Point2f firstP, cv::Point2f point)
{
	bool k;
...
void SweepingPlane::splitPoly(std::vector<cv::Point2f>& polyP, int from, int to)
{
